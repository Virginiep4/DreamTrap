...
public class Welcome {
	...
	public void draw(Graphics g, Character character, LevelManager levelManager) {
		...
		g.fillRect(0, 0, (int) (BLOCK_SIZE * Screen.BLOCK_PER_WIDTH * SCALE), (int) (BLOCK_SIZE * Screen.BLOCK_PER_HEIGHT * SCALE));
		int x;
		int y;
		String text;
		...
		x = (int) ((BLOCK_SIZE * Screen.BLOCK_PER_WIDTH * SCALE) / 2);
		y = (int)(200*Screen.getRatioheight());

		g.drawString(text, x, y);

		g.drawImage(character.getCharacter()[0][0], ((int) ((BLOCK_SIZE * Screen.BLOCK_PER_WIDTH * SCALE) / 3)), 250, 200, 182,
				null);

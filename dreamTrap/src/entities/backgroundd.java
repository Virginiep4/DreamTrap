...
public class backgroundd extends Entities{
	...
	void importEntity() {
		...
		backgroundd[2][0] = importImg("/PageAccueil 3e.png");
		backgroundd[2][1]=importImg("/PageAccueil 3e.png");
		
		backgroundd[3] = new BufferedImage[2];
		backgroundd[3][0] = importImg("/PageAccueil 3e.png");
		backgroundd[3][1]=importImg("/PageAccueil 3e.png");
		
		backgroundd[4] = new BufferedImage[2];
		backgroundd[4][0] = importImg("/PageAccueil 3e.png");
		backgroundd[4][1]=importImg("/PageAccueil 3e.png");
		
		backgroundd[5] = new BufferedImage[2];
		backgroundd[5][0] = importImg("/PageAccueil 3e.png");
		backgroundd[5][1]=importImg("/PageAccueil 3e.png");
		
		backgroundd[6] = new BufferedImage[2];
		backgroundd[6][0] = importImg("/PageAccueil 3e.png");
		backgroundd[6][1]=importImg("/PageAccueil 3e.png");
